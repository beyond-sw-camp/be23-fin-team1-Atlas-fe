...
export const supplierNetworkNodes: MonitoringMapNode[] = [
  {
    ...
    latLng: [48.85, 2.35],
    displayName: { ko: '유럽 허브 01', en: '유럽 허브 01' },
    summary: { ko: '파리 밀집 클러스터', en: '파리 밀집 클러스터' },
  },
  {
    ...
    latLng: [1.29, 103.85],
    displayName: { ko: '싱가포르 항만', en: '싱가포르 항만' },
    summary: { ko: '물류 지연 +14%', en: '물류 지연 +14%' },
  },
  {
    label: 'SHANGHAI_NODE',
    ...
    latLng: [31.23, 121.47],
    displayName: { ko: '상하이 노드', en: '상하이 노드' },
    summary: { ko: '혼잡 신호 +12시간', en: '혼잡 신호 +12시간' },
  },
  {
    label: 'NEW_JERSEY_DC',
    ...
    latLng: [40.73, -74.17],
    displayName: { ko: '뉴저지 물류센터', en: '뉴저지 물류센터' },
    summary: { ko: '입고 용량 초과', en: '입고 용량 초과' },
  },
]
...
export const controlTowerNodes: MonitoringMapNode[] = [
  {
    ...
    latLng: [51.92, 4.48],
    displayName: { ko: '로테르담 출발지', en: '로테르담 출발지' },
    summary: { ko: '활성 트랜잭션 14건', en: '활성 트랜잭션 14건' },
  },
  {
    ...
    latLng: [34.05, -118.24],
    displayName: { ko: '태평양 루트 04', en: '태평양 루트 04' },
    summary: { ko: '핵심 레인 +4시간 편차', en: '핵심 레인 +4시간 편차' },
  },
  {
    ...
    latLng: [40.73, -74.17],
    displayName: { ko: '뉴저지 터미널', en: '뉴저지 터미널' },
    summary: { ko: '창고 반입량 12.4k MT', en: '창고 반입량 12.4k MT' },
  },
  {
    label: 'TOKYO_BUFFER',
    ...
    latLng: [35.68, 139.69],
    displayName: { ko: '도쿄 버퍼', en: '도쿄 버퍼' },
    summary: { ko: '복구 ETA 임계치 이내', en: '복구 ETA 임계치 이내' },
  },
]
